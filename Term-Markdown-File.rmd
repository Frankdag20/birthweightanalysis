...
output: 
  pdf_document:
    ...
    # Make sure to change template to the directory in which template-tex is
    template: /<Your directory>/template-tex.tex
bibliography: master.bib
#header-includes:
#  -  \usepackage{hyperref}
biblio-style: apsr
title: "Analysis of Child Birthweight Factors and Relationships"

author:
- name: Frank D'Agostino, Jothi Ramaswamy
  affiliation: Harvard College
abstract: "Mathematics for Statistics, Computation, and Data Science (Math 23c) Term Project"
#keywords: "term project"
